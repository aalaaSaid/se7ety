...
import 'package:se7ety/features/doctor/profile/presentation/pages/doctor_setting_screen.dart';
import 'package:se7ety/features/doctor/profile/presentation/widgets/doctor_appointments_list.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              splashRadius: 20,
              onPressed: () {
                navigateTo(context, const DoctorSettingScreen());
              },
              icon: const Icon(
                Icons.settings,
